...
- Updated `README.md` so the repo front page now exposes:
  ...
  - `docs/testing/2026-03-13_TESTING_LOG_HISTORY.md` as recommended reading
...
- Updated `docs/workflow/2026-03-11_WORKFLOW_GIT_GUIDE.md` wording so the workflow rule reads as a general project rule rather than a Codex-only one.
...
- New document:
  - `docs/experiments/2026-03-14_EXPERIMENT_ISO_PLAYER_HARDENING_REPORT.md`
...
- Validation performed:
  - `./scripts/validate-wsl.sh`
- New document:
  - `docs/experiments/2026-03-14_EXPERIMENT_CLEANUP_NPE_HARDENING_REPORT.md`
...
- New document:
  - `docs/experiments/2026-03-14_EXPERIMENT_DEBUG_DELETE_COMBAT_GUARD_REPORT.md`
...
- New document:
  - `docs/testing/2026-03-14_LOGGING_TEST_QUALITY_TUNING.md`
...
- New document:
  - `docs/plans/2026-03-14_PLAN_ISOPLAYER_EXIT.md`
...
- New document:
  - `docs/plans/2026-03-14_PLAN_CARRIER_ADAPTER_DRAFT.md`
...
- New document:
  - `docs/experiments/2026-03-14_EXPERIMENT_CARRIER_ADAPTER_MIGRATION_PASS_REPORT.md`
- Important scope note:
...
- New document:
  - `docs/experiments/2026-03-14_EXPERIMENT_CARRIER_ISOSURVIVOR_SPIKE_REPORT.md`
...
- New document:
  - `docs/plans/2026-03-14_PLAN_CARRIER_ISOZOMBIE_SPIKE.md`
...
- Wrote a consolidated result summary and verdict document:
  - `docs/experiments/2026-03-14_EXPERIMENT_CARRIER_RESULTS_REPORT.md`
...
- New document:
  - `docs/experiments/2026-03-14_EXPERIMENT_CARRIER_ISOZOMBIE_SPIKE_IMPLEMENTATION_REPORT.md`
...
- New document:
  - `docs/experiments/2026-03-14_EXPERIMENT_CARRIER_ISOZOMBIE_RESOLVE_HARDENING_REPORT.md`
...
- New document:
  - `docs/experiments/2026-03-14_EXPERIMENT_CARRIER_ISOZOMBIE_SYNC_UI_BRANCHING_REPORT.md`
...
- New document:
  - `docs/experiments/2026-03-14_EXPERIMENT_CARRIER_ISOZOMBIE_MANAGED_TARGET_FINALIZATION_REPORT.md`
...
- New document:
  - `docs/experiments/2026-03-14_EXPERIMENT_CARRIER_ISOZOMBIE_SUCCESS_RESULT_REPORT.md`
...
- New document:
  - `docs/experiments/2026-03-14_EXPERIMENT_CARRIER_ISOZOMBIE_TRUST_HOSTILITY_REPORT.md`
...
- New document:
  - `docs/handoffs/2026-03-14_HANDOFF_NEXT_SESSION.md`
